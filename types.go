// Package aerotyfi provides the Go SDK for the KANERO Fi privacy-native neo bank protocol.
package aerotyfi
...
// KANEROError is the structured error returned by the KANERO API.
type KANEROError struct {
...
func (e KANEROError) Error() string {
	return fmt.Sprintf("aerotyfi: [%d] %s — %s", e.Status, e.Code, e.Message)
}
...
// KANEROConfig holds the configuration for an KANEROClient.
type KANEROConfig struct {
	APIKey       string
	BaseURL      string
	WsURL        string
