// Package privenoxfi provides the Go SDK for the privenox Fi privacy-native neo bank protocol.
package privenoxfi
...
// privenoxError is the structured error returned by the privenox API.
type privenoxError struct {
...
func (e privenoxError) Error() string {
	return fmt.Sprintf("privenoxfi: [%d] %s — %s", e.Status, e.Code, e.Message)
}
...
// privenoxConfig holds the configuration for an privenoxClient.
type privenoxConfig struct {
	APIKey       string
	BaseURL      string
	WsURL        string
